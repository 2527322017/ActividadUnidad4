      ...
      body: Container(
        ...
        child: Column(
          ...
          children: [
            getLabel("Categorias"),
            SizedBox(height: 15),
            OptionItem(text: "Huevos"),
            SizedBox(height: 15),
            OptionItem(text: "Noodles y Pasta"),
            SizedBox(height: 15),
            OptionItem(text: "Chips & Crisps"),
            SizedBox(height: 15),
            OptionItem(text: "Comida rápida"),
            SizedBox(height: 30),
            getLabel("Marcas"),
            SizedBox(height: 15),
            OptionItem(text: "Colección Individual"),
            SizedBox(height: 15),
            OptionItem(text: "Cocacola"),
            SizedBox(height: 15),
            OptionItem(text: "Pepsi"),
            SizedBox(height: 15),
            OptionItem(text: "Otras"),
            Spacer(),
            AppButton(
              label: "Apply Filter",
